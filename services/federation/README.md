...
[Prebuilt binaries](https://github.com/TheLUGANSKIY/go/releases) of the federation server are available on the [releases page](https://github.com/TheLUGANSKIY/go/releases).
...
```
go get -u github.com/TheLUGANSKIY/go/services/federation
```
